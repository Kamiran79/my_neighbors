...
class Order(models.Model):
  ...
  isConfirmed = models.BooleanField() # Chef confirm that making the order - transaction the fee to the owner bank
  ...
  isDelivered_user = models.BooleanField() #user confirm picked the order make the status complete
